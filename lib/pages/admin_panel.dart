...
class _AdminPanelState extends State<AdminPanel> {
  ...
  int _selectedIndex = 0; // 0 = Usuarios, 1 = Partidas
              ...
              child: ListTile(
                ...
                trailing: Wrap(
                  ...
                  children: [
                    ...
                    // Ban
                    IconButton(
                      icon: Icon(banned ? Icons.lock_open : Icons.lock,
  ...
  Widget _buildMatchesList() {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (matches.isEmpty) return const Center(child: Text("No hay partidas"));
          ...
          itemBuilder: (context, index) {
            ...
            return Card(
              ...
              child: ListTile(
                ...
                title: Text("${match['map']} | ${match['score']}",
                    style: const TextStyle(color: Colors.white)),
                subtitle: Text("Kills: ${match['kills']}  Deaths: ${match['deaths']}",
                    style: const TextStyle(color: Colors.white70)),
                trailing: IconButton(
                  icon: const Icon(Icons.delete, color: Colors.redAccent),
                  onPressed: () => _firestore.collection("matches").doc(id).delete(),
                ),
              ),
            );
          },
